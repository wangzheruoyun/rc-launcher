...
fn replace_word(haystack: &str, needle: &str, replacement: &str) -> String {
    ...
    while i < haystack.len() {
        ...
        let left_ok = start == 0
            || !haystack.as_bytes()[start - 1].is_ascii_alphabetic();
        let right_ok = end >= haystack.len()
            || !haystack.as_bytes()[end].is_ascii_alphabetic();
        if left_ok && right_ok {
...
pub const MOD_DICTIONARY: &[(&str, &str, &str, &str)] = &[
    ...
    ("xaeros-minimap", "Xaero's Minimap", "Xaero 小地图", "Xaero 小地圖"),
    ("xaeros-worldmap", "Xaero's World Map", "Xaero 世界地图", "Xaero  世界地圖"),
    ("voxelmap", "VoxelMap", "体素地图", "體素地圖"),
    ("inventory-profiles-next", "Inventory Profiles Next", "背包配置", "背包配置"),
    ("appleskin", "AppleSkin", "苹果皮", "蘋果皮"),
    ("chat-toast", "Chat Toast", "聊天提示", "聊天提示"),
    ("comforts", "Comforts", "舒适", "舒適"),
    ("decorative-blocks", "Decorative Blocks", "装饰方块", "裝飾方塊"),
    ("supplementaries", "Supplementaries", "补充", "補充"),
    ("farmers-delight", "Farmer's Delight", "农夫乐事", "農夫樂事"),
    ("create", "Create", "机械动力", "機械動力"),
    ("mekanism", "Mekanism", "通用机械", "通用機械"),
    ("thermal-foundation", "Thermal Foundation", "热力基础", "熱力基礎"),
    ("thermal-expansion", "Thermal Expansion", "热力扩展", "熱力擴展"),
    ("tinkers-construct", "Tinkers' Construct", "匠魂", "匠魂"),
    ("applied-energistics-2", "Applied Energistics 2", "应用能源 2", "應用能源 2"),
    ("ae2", "AE2", "应用能源 2", "應用能源 2"),
    ("refined-storage", "Refined Storage", "精致存储", "精緻儲存"),
    ("immersive-engineering", "Immersive Engineering", "沉浸工程", "沉浸工程"),
    ("immersiveportals", "Immersive Portals", "沉浸式传送门", "沉浸式傳送門"),
    ("biomes-o-plenty", "Biomes O' Plenty", "超多生物群系", "超多生物群系"),
    ("terralith", "Terralith", "大地之理", "大地之理"),
    ("tectonic", "Tectonic", "大地构造", "大地構造"),
    ("nullscape", "Nullscape", "虚空景", "虛空景"),
    ("amplified-nether", "Amplified Nether", "放大下界", "放大下界"),
    ("fabric-api", "Fabric API", "Fabric API", "Fabric API"),
    ("fabricloader", "Fabric Loader", "Fabric 加载器", "Fabric 載入器"),
    ...
    ("simple-voice-chat", "Simple Voice Chat", "简易语音聊天", "簡易語音聊天"),
    ("vinyl", "Vinyl", "唱片", "唱片"),
    ("jmx", "JMX", "JMX", "JMX"),
    ("discord-integration", "Discord Integration", "Discord 集成", "Discord 集成"),
    ("patcher", "Patcher", "补丁工具", "補丁工具"),
    ("notenoughcrashes", "Not Enough Crashes", "不再崩溃", "不再崩潰"),
    ("capability-adapter", "Capability Adapter", "能力适配", "能力適配"),
    ...
    ("complementary-reimagined", "Complementary Reimagined", "互补重制", "互補重製"),
    ("seus-ptgi-e12", "SEUS PTGI E12", "SEUS PTGI E12", "SEUS PTGI E12"),
    ...
    ("c2me", "Concurrent Chunk Management Engine", "并发区块管理引擎", "並行區塊管理引擎"),
    ("moreculling", "MoreCulling", "更多剔除", "更多剔除"),
    ("fabric-carpet", "Carpet", "地毯", "地毯"),
    ("litematica-fabric", "Litematica Fabric", "Litematica Fabric 版", "Litematica Fabric 版"),
    ("mafgull", "MaFgLib", "MaFgLib", "MaFgLib"),
    ("fabric-language-kotlin", "Fabric Language Kotlin", "Fabric Kotlin 支持", "Fabric Kotlin 支援"),
    ("kotlin-for-forge", "Kotlin for Forge", "Forge Kotlin 支持", "Forge Kotlin 支援"),
    ("library-ferret", "Library Ferret", "库搜索", "庫搜尋"),
    ("lambdacontrol", "Lambda Controls", "Lambda 控件", "Lambda 控件"),
    ...
    ("ferritecore", "FerriteCore", "铁芯", "鐵芯"),
    ("structure-gel-api", "Structure Gel API", "结构凝胶 API", "結構凝膠 API"),
    ("drippy-loadscreen", "Drippy Loadscreen", "Drippy 加载屏", "Drippy 載入屏"),
    ("bobby", "Bobby", "Bobby", "Bobby"),
    ("gravestone", "Gravestone", "墓碑", "墓碑"),
    ("gravestones-fabric", "Gravestones (Fabric)", "墓碑 (Fabric)", "墓碑 (Fabric)"),
    ("carryon", "Carry On", "搬运", "搬運"),
    ("easy-npc", "Easy NPC", "简易 NPC", "簡易 NPC"),
    ("furniture", "Furniture", "家具", "家具"),
    ("macaw-furniture", "Macaw's Furniture", "Macaw 家具", "Macaw 家具"),
    ("macaw-bridges", "Macaw's Bridges", "Macaw 桥", "Macaw 橋"),
    ("macaw-roofs", "Macaw's Roofs", "Macaw 屋顶", "Macaw 屋頂"),
    ("macaw-windows", "Macaw's Windows", "Macaw 窗户", "Macaw 窗戶"),
    ("chipped", "Chipped", "碎片", "碎片"),
    ("quark", "Quark", "夸克", "夸克"),
    ("enviro", "Enviro", "环境", "環境"),
    ("seasonals", "Seasonals", "季节", "季節"),
    ("serene-seasons", "Serene Seasons", "宁静四季", "寧靜四季"),
    ("immersive-meteorology", "Immersive Meteorology", "沉浸气象", "沉浸氣象"),
    ("yungs-api", "YUNG's API", "YUNG API", "YUNG API"),
    ("yungs-better-dungeons", "YUNG's Better Dungeons", "YUNG 更好地下城", "YUNG 更好地下城"),
    ("yungs-better-strongholds", "YUNG's Better Strongholds", "YUNG 更好要塞", "YUNG 更好要塞"),
    ("yungs-better-mineshafts", "YUNG's Better Mineshafts", "YUNG 更好矿井", "YUNG 更好礦井"),
    ("yungs-better-nether-fortresses", "YUNG's Better Nether Fortresses", "YUNG 更好下界要塞", "YUNG 更好下界要塞"),
    ("yungs-extras", "YUNG's Extras", "YUNG 补充", "YUNG 補充"),
    ("dungeons-and-taverns", "Dungeons & Taverns", "地下城与酒馆", "地下城與酒館"),
    ("towns-and-towers", "Towns & Towers", "城镇与塔", "城鎮與塔"),
    ("when-dungeons-arise", "When Dungeons Arise", "地下城崛起", "地下城崛起"),
    ("farming-crossing", "Farming Crossing", "农场十字路口", "農場十字路口"),
    ("mca-select", "MCA Selector", "MCA 选择器", "MCA 選擇器"),
    ("sit", "Sit", "坐下", "坐下"),
    ("pokeball", "Pokeball", "精灵球", "精靈球"),
    ("pixelmon", "Pixelmon", "精灵宝可梦", "精靈寶可夢"),
    ("pixelmon-generations", "Pixelmon Generations", "精灵宝可梦世代", "精靈寶可夢世代"),
    ("radon", "Radon", "氡", "氡"),
    ("draco-ars", "Draco Ars", "龙之术", "龍之術"),
    ("mythic-upgrades", "Mythic Upgrades", "神秘升级", "神秘升級"),
    ("tomb-many-graves", "Tomb Many Graves", "集体墓碑", "集體墓碑"),
    ("cosmetic-armor", "Cosmetic Armor", "装饰盔甲", "裝飾盔甲"),
    ("wonderful-enchantments", "Wonderful Enchantments", "精彩附魔", "精彩附魔"),
    ("enchantment-descriptions", "Enchantment Descriptions", "附魔说明", "附魔說明"),
    ("appleskin", "AppleSkin", "苹果皮", "蘋果皮"),
    ("spice-of-life", "Spice of Life", "人生情趣", "人生情趣"),
    ("diet", "Diet", "饮食", "飲食"),
    ("hydration", "Hydration", "补水", "補水"),
    ("mca-dragon-survival", "MCA Dragon Survival", "MCA 龙之生存", "MCA 龍之生存"),
    ...
    ("aquaculture-delight", "Aquaculture Delight", "水产乐事", "水產樂事"),
    ...
    ("twilight-forest", "The Twilight Forest", "暮色森林", "暮色森林"),
    ("aether", "Aether", "以太", "以太"),
    ("aether-redux", "Aether Redux", "以太重制", "以太重製"),
    ("the-aether", "The Aether", "以太", "以太"),
    ("lost-aether-content", "Lost Aether Content", "失落以太", "失落以太"),
    ...
    ("netherportals", "Nether Portals", "下界传送门", "下界傳送門"),
    ("backpacked", "Backpacked", "背包", "背包"),
    ("sophisticated-backpacks", "Sophisticated Backpacks", "精致背包", "精緻背包"),
    ("sophisticated-storage", "Sophisticated Storage", "精致存储", "精緻儲存"),
    ("iron-chests", "Iron Chests", "铁箱子", "鐵箱子"),
    ("nomi", "NOMI Labs", "NOMI 实验", "NOMI 實驗"),
    ("travelers-backpack", "Traveler's Backpack", "旅行背包", "旅行背包"),
    ("useful-backpacks", "Useful Backpacks", "实用背包", "實用背包"),
    ("backpack-mod", "Backpack Mod", "背包模组", "背包模組"),
    ("kobolds", "Kobolds", "狗头人", "狗頭人"),
    ("guard-villagers", "Guard Villagers", "守卫村民", "守衛村民"),
    ("guard-villagers-fabric", "Guard Villagers (Fabric)", "守卫村民 (Fabric)", "守衛村民 (Fabric)"),
...
pub const LOADER_DICTIONARY: &[(&str, &str, &str, &str)] = &[
    ...
    ("optifine", "OptiFine", "OptiFine", "OptiFine"),
    ("risugami", "Risugami's ModLoader", "Risugami 模组加载器", "Risugami 模組載入器"),
...
mod tests {
    ...
    fn dictionary_lookup_returns_some_for_known_term() {
        let d = BuiltInDictionary::builtin();
        let hit = d.lookup_term("render distance").expect("render distance known");
